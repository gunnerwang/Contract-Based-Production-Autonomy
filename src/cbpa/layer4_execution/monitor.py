...
class ContractMonitor:
    ...
    checked alongside KPI monitoring; hard failures abort software execution.
    A guard event is not evidence of a physical intervention.
    """
    ...
    def check(self, metrics: SimulationMetrics) -> list[MonitorAlert]:
        ...
        first, without modifying observations. Hard failures propagate to the
        caller before KPI margin calculations run.
        """
